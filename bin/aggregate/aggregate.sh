...
for c in maize soybean sorghum cotton wheat; do
   ...
   ydaggfile=$indir/$c/final/$c.reference.agg.nc4
   ...
   /project/joshuaelliott/psims/bin/agg.out.py -i reference.nc4:yield -w weights.nc4 -a $aggfile -n 10 -l time -o $ydaggfile
   rm weights.nc4 reference.nc4
done
