...
for c in maize soybean sorghum cotton; do
    ...
    file1=$c/final/$c.crop_progress.nc4 # 1980-2012
    file2=$c/final/$c.crop_progress.2009-2014.nc4 # 2009-2014
    resfile=$c/final/$c.crop_progress.2009-2014.residuals.nc4
    finalfile=$c/final/$c.crop_progress.1980-2014.nc4
